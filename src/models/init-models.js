...
function initModels(sequelize) {
  ...
  reff_menu.belongsToMany(roles, { as: 'role_id_roles', through: role_menu, foreignKey: "menu_id", otherKey: "role_id" });
  roles.belongsToMany(reff_menu, { as: 'menu_id_reff_menus', through: role_menu, foreignKey: "role_id", otherKey: "menu_id" });
  ...
  member.belongsTo(member, { as: "member_id_parent_member", foreignKey: "member_id_parent"});
  member.hasMany(member, { as: "members", foreignKey: "member_id_parent"});
  ...
  ranking.hasMany(member, { as: "members", foreignKey: "ranking_id"});
  ranking_req.belongsTo(ranking, { as: "ranking", foreignKey: "ranking_id"});
  ranking.hasMany(ranking_req, { as: "ranking_reqs", foreignKey: "ranking_id"});
  ranking_req.belongsTo(ranking, { as: "ranking_id_member_ranking", foreignKey: "ranking_id_member"});
  ranking.hasMany(ranking_req, { as: "ranking_id_member_ranking_reqs", foreignKey: "ranking_id_member"});
  bonus.belongsTo(reff_bonus_status, { as: "bonus_status", foreignKey: "bonus_status_id"});
  reff_bonus_status.hasMany(bonus, { as: "bonuses", foreignKey: "bonus_status_id"});
  ...
  reff_user_status.hasMany(member, { as: "members", foreignKey: "user_status_id"});
  ...
  audits.belongsTo(users, { as: "user", foreignKey: "user_id"});
  users.hasMany(audits, { as: "audits", foreignKey: "user_id"});
